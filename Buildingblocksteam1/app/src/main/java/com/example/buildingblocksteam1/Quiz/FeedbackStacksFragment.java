...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackStacksBinding;
 ...
 * Use the {@link FeedbackStacksFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackStacksFragment extends Fragment {
    ...
    private FragmentFeedbackStacksBinding binding;
    private SharedViewModel viewModel;

    public FeedbackStacksFragment() {
     ...
     * @return A new instance of fragment FeedbackStacksFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackStacksFragment newInstance(String param1, String param2) {
        FeedbackStacksFragment fragment = new FeedbackStacksFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackStacksBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getStacksQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackStacksFragment.this)
                        .navigate(R.id.action_feedbackStacksFragment_to_quizMenuFragment);
            }
        });
