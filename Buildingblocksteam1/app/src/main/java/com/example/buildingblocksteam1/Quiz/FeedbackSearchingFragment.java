...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackSearchingBinding;
 ...
 * Use the {@link FeedbackSearchingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackSearchingFragment extends Fragment {
    ...
    private FragmentFeedbackSearchingBinding binding;
    private SharedViewModel viewModel;

    public FeedbackSearchingFragment() {
     ...
     * @return A new instance of fragment FeedbackSearchingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackSearchingFragment newInstance(String param1, String param2) {
        FeedbackSearchingFragment fragment = new FeedbackSearchingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackSearchingBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getSearchingQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackSearchingFragment.this)
                        .navigate(R.id.action_feedbackSearchingFragment_to_quizMenuFragment);
            }
        });
