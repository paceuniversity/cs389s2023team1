...
public class GreedyFlashcardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flashcards.add(new Flashcards("What are some advantages of using a linked list over an array?", "Linked lists can dynamically grow or shrink, insert or delete elements at constant time complexity (in certain cases), and use only the memory required for their elements (unlike greedy, which may have unused memory if their size is larger than the number of elements they store)."));
