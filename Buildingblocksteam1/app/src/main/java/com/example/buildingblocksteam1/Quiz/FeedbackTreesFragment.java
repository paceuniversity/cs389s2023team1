...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackTreesBinding;
 ...
 * Use the {@link FeedbackTreesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackTreesFragment extends Fragment {
    ...
    private FragmentFeedbackTreesBinding binding;
    private SharedViewModel viewModel;

    public FeedbackTreesFragment() {
     ...
     * @return A new instance of fragment FeedbackTreesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackTreesFragment newInstance(String param1, String param2) {
        FeedbackTreesFragment fragment = new FeedbackTreesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackTreesBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getTreesQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackTreesFragment.this)
                        .navigate(R.id.action_feedbackTreesFragment_to_quizMenuFragment);
            }
        });
