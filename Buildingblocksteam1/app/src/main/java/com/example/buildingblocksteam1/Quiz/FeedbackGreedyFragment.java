...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackGreedyBinding;
 ...
 * Use the {@link FeedbackGreedyFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackGreedyFragment extends Fragment {
    ...
    private FragmentFeedbackGreedyBinding binding;
    private SharedViewModel viewModel;

    public FeedbackGreedyFragment() {
     ...
     * @return A new instance of fragment FeedbackGreedyFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackGreedyFragment newInstance(String param1, String param2) {
        FeedbackGreedyFragment fragment = new FeedbackGreedyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackGreedyBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getGreedyQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackGreedyFragment.this)
                        .navigate(R.id.action_feedbackGreedyFragment_to_quizMenuFragment);
            }
        });
