...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackDynamicBinding;
 ...
 * Use the {@link FeedbackDynamicFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackDynamicFragment extends Fragment {
    ...
    private FragmentFeedbackDynamicBinding binding;
    private SharedViewModel viewModel;

    public FeedbackDynamicFragment() {
     ...
     * @return A new instance of fragment FeedbackDynamicFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackDynamicFragment newInstance(String param1, String param2) {
        FeedbackDynamicFragment fragment = new FeedbackDynamicFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackDynamicBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getDynamicQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackDynamicFragment.this)
                        .navigate(R.id.action_feedbackDynamicFragment_to_quizMenuFragment);
            }
        });
