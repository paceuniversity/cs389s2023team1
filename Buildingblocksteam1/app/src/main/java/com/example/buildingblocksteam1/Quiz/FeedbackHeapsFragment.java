...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackHeapsBinding;
 ...
 * Use the {@link FeedbackHeapsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackHeapsFragment extends Fragment {
    ...
    private FragmentFeedbackHeapsBinding binding;
    private SharedViewModel viewModel;

    public FeedbackHeapsFragment() {
     ...
     * @return A new instance of fragment FeedbackHeapsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackHeapsFragment newInstance(String param1, String param2) {
        FeedbackHeapsFragment fragment = new FeedbackHeapsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackHeapsBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getHeapsQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackHeapsFragment.this)
                        .navigate(R.id.action_feedbackHeapsFragment_to_quizMenuFragment);
            }
        });
