...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackDivideAndConquerBinding;
 ...
 * Use the {@link FeedbackDivideAndConquerFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackDivideAndConquerFragment extends Fragment {
    ...
    private FragmentFeedbackDivideAndConquerBinding binding;
    private SharedViewModel viewModel;

    public FeedbackDivideAndConquerFragment() {
     ...
     * @return A new instance of fragment FeedbackDivideAndConquerFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackDivideAndConquerFragment newInstance(String param1, String param2) {
        FeedbackDivideAndConquerFragment fragment = new FeedbackDivideAndConquerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackDivideAndConquerBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getDivideAndConquerQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackDivideAndConquerFragment.this)
                        .navigate(R.id.action_feedbackDivideAndConquerFragment_to_quizMenuFragment);
            }
        });
