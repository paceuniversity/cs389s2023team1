...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackBruteForceBinding;
 ...
 * Use the {@link FeedbackBruteForceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackBruteForceFragment extends Fragment {
    ...
    private FragmentFeedbackBruteForceBinding binding;
    private SharedViewModel viewModel;

    public FeedbackBruteForceFragment() {
     ...
     * @return A new instance of fragment FeedbackBruteForceFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackBruteForceFragment newInstance(String param1, String param2) {
        FeedbackBruteForceFragment fragment = new FeedbackBruteForceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackBruteForceBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getBruteForceQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackBruteForceFragment.this)
                        .navigate(R.id.action_feedbackBruteForceFragment_to_quizMenuFragment);
            }
        });
