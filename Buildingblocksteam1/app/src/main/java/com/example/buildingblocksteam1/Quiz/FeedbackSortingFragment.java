...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackSortingBinding;
 ...
 * Use the {@link FeedbackSortingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackSortingFragment extends Fragment {
    ...
    private FragmentFeedbackSortingBinding binding;
    private SharedViewModel viewModel;

    public FeedbackSortingFragment() {
     ...
     * @return A new instance of fragment FeedbackSortingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackSortingFragment newInstance(String param1, String param2) {
        FeedbackSortingFragment fragment = new FeedbackSortingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackSortingBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getSortingQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackSortingFragment.this)
                        .navigate(R.id.action_feedbackSortingFragment_to_quizMenuFragment);
            }
        });
