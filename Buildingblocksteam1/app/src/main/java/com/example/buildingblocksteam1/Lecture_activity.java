 ...
 * Use the {@link Lecture_activity#newInstance} factory method to
...
public class Lecture_activity extends Fragment {
     ...
     * @return A new instance of fragment Lecture_activity.
     */
    // TODO: Rename and change types and number of parameters
    public static Lecture_activity newInstance(String param1, String param2) {
        Lecture_activity fragment = new Lecture_activity();
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController( Lecture_activity.this)
                        .navigate( R.id.action_lecture_activity2_to_algorithmsTopicsFragment2);
            }
        });
