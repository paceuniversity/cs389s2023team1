...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackGraphsBinding;
 ...
 * Use the {@link FeedbackGraphsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackGraphsFragment extends Fragment {
    ...
    private FragmentFeedbackGraphsBinding binding;
    private SharedViewModel viewModel;

    public FeedbackGraphsFragment() {
     ...
     * @return A new instance of fragment FeedbackGraphsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackGraphsFragment newInstance(String param1, String param2) {
        FeedbackGraphsFragment fragment = new FeedbackGraphsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackGraphsBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getGraphsQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackGraphsFragment.this)
                        .navigate(R.id.action_feedbackGraphsFragment_to_quizMenuFragment);
            }
        });
