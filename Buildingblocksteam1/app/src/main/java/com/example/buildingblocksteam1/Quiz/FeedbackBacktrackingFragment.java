...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackBacktrackingBinding;
 ...
 * Use the {@link FeedbackBacktrackingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackBacktrackingFragment extends Fragment {
    ...
    private FragmentFeedbackBacktrackingBinding binding;
    private SharedViewModel viewModel;

    public FeedbackBacktrackingFragment() {
     ...
     * @return A new instance of fragment FeedbackBacktrackingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackBacktrackingFragment newInstance(String param1, String param2) {
        FeedbackBacktrackingFragment fragment = new FeedbackBacktrackingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackBacktrackingBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getBacktrackingQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackBacktrackingFragment.this)
                        .navigate(R.id.action_feedbackBacktrackingFragment_to_quizMenuFragment);
            }
        });
