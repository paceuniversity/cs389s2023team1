...
public class LinkedListFlashcardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flashcards.add(new Flashcards("What is the difference between an array and a linked list?", "An array has a fixed size and stores its elements in contiguous memory locations, whereas a linked list can dynamically grow or shrink and stores its elements in non-contiguous memory locations."));
        ...
        flashcards.add(new Flashcards("What are some advantages of using a linked list over an array?", "Linked lists can dynamically grow or shrink, insert or delete elements at constant time complexity (in certain cases), and use only the memory required for their elements (unlike arrays, which may have unused memory if their size is larger than the number of elements they store)."));
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(LinkedListFlashcardFragment.this)
                        .navigate(R.id.action_linkedListFlashcardFragment_to_flashcardMenuFragment);
            }
        });
