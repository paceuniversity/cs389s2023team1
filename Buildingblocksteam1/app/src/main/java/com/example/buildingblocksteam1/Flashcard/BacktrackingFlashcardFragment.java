...
public class BacktrackingFlashcardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flashcards.add(new Flashcards("What is the difference between an array and a linked list?", "An array has a fixed size and stores its elements in contiguous memory locations, whereas a linked list can backtrackingally grow or shrink and stores its elements in non-contiguous memory locations."));
        ...
        flashcards.add(new Flashcards("What are some advantages of using a linked list over an array?", "Linked lists can backtrackingally grow or shrink, insert or delete elements at constant time complexity (in certain cases), and use only the memory required for their elements (unlike backtracking, which may have unused memory if their size is larger than the number of elements they store)."));
