...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackQueuesBinding;
 ...
 * Use the {@link FeedbackQueuesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackQueuesFragment extends Fragment {
    ...
    private FragmentFeedbackQueuesBinding binding;
    private SharedViewModel viewModel;

    public FeedbackQueuesFragment() {
     ...
     * @return A new instance of fragment FeedbackQueuesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackQueuesFragment newInstance(String param1, String param2) {
        FeedbackQueuesFragment fragment = new FeedbackQueuesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackQueuesBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getQueuesQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackQueuesFragment.this)
                        .navigate(R.id.action_feedbackQueuesFragment_to_quizMenuFragment);
            }
        });
