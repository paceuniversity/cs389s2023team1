...
import com.example.buildingblocksteam1.databinding.FragmentFeedbackHashTablesBinding;
 ...
 * Use the {@link FeedbackHashTablesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeedbackHashTablesFragment extends Fragment {
    ...
    private FragmentFeedbackHashTablesBinding binding;
    private SharedViewModel viewModel;

    public FeedbackHashTablesFragment() {
     ...
     * @return A new instance of fragment FeedbackHashTablesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeedbackHashTablesFragment newInstance(String param1, String param2) {
        FeedbackHashTablesFragment fragment = new FeedbackHashTablesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFeedbackHashTablesBinding.inflate(inflater, container, false);
        ...
        ArrayList<Question> questions = viewModel.getHashTablesQuestions().getValue();
        for (int i = 0; i < 10; i++) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(FeedbackHashTablesFragment.this)
                        .navigate(R.id.action_feedbackHashTablesFragment_to_quizMenuFragment);
            }
        });
